...
class Product extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final ProductController prod = Get.put(ProductController());
    ...
    if (gen.scrWidth <= 600) {
      ...
      prod.gridCount.value = 2;
    } else {
      gen.resWidth = gen.scrWidth * 0.75;
      prod.gridCount.value = 3;
    }
                      ...
                      children: [
                        ...
                        Obx(
                          () => Text(
                            prod.results +
                                ": " +
                                prod.prodList.length.toString(),
                            style: TextStyle(
                              fontSize: gen.resWidth * 0.04,
                            ),
                          ),
                        ),
                        ...
                        Expanded(
                          child: Obx(
                            () => GridView.count(
                              crossAxisSpacing: 20,
                              mainAxisSpacing: 10,
                              crossAxisCount: prod.gridCount.value,
                              controller: prod.scrollController,
                              children: List.generate(
                                prod.scrollCount.value,
                                (index) {
